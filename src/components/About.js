            ...
            <div className="col-md-8 offset-md-2">
              ...
              <div>
                ...
                <ul>
                  ...
                  <li className="fs-5">
                    <span className="fs-4 text-info">Ease of Booking</span>{" "}
                    Streamlined booking process with user-friendly interfaces
                    and transparent pricing, making it convenient to reserve and
                    manage event spaces.
                  </li>
                  <li className="fs-4">
                    <span className="fs-4 text-info">
                    ...
                    From catering options to event planning assistance, the app
                    provides comprehensive services to facilitate seamless and
