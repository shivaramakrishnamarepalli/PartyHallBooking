...
const EditHall = () => {
  ...
  useEffect(() => {
    async function getHall() {
      ...
      try {
        ...
        console.log(hall);
        const hall1 = response.data;
        setFormData({
          hall_id: hall1 ? hall1.hall_id : "",
          hall_name: hall1 ? hall1.hall_name : "",
          hall_address: hall1 ? hall1.hall_address : "",
          admin_id: `${localStorage.getItem("user_id")}`,
          status: hall1 ? hall1.status : "",
          hall_rental_cost: hall1 ? hall1.hall_rental_cost : "",
          hall_max_capacity: hall1 ? hall1.hall_max_capacity : "",
          hall_price_per_plate: hall1 ? hall1.hall_price_per_plate : "",
          hall_duration: "24",
          hall_rating: "0",
          // hall_image: "",
        });
  ...
  const [formData, setFormData] = useState({
    ...
    hall_name: hall ? hall.hall_name : "",
    hall_address: hall ? hall.hall_address : "",
    admin_id: `${localStorage.getItem("user_id")}`,
    status: hall ? hall.status : "",
    hall_rental_cost: hall ? hall.hall_rental_cost : "",
    hall_max_capacity: hall ? hall.hall_max_capacity : "",
    hall_price_per_plate: hall ? hall.hall_price_per_plate : "",
    hall_duration: "24",
    hall_rating: hall ? hall.hall_rating : 0,
    // hall_image: "",
  });
  ...
  const handleSubmit1 = async (e) => {
    ...
    await axios
      .post(
        "http://localhost:3006/api/admin/editHall",
        {
          ...formData,
          id: id,
        },
